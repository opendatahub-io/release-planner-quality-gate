...
FPDoR Phase 1 hard checks (all applicable checks must pass for `rp-qg1-pass`):
...
AI First = any `strat-creator-*` label present. Legacy Features skip sign-off/rubric.
...
| Label | Meaning |
|-------|---------|
| `rp-qg1-pass` | Passed Gate 1 (applicable FPDoR Phase 1 checks) |
